...
def _build_template_context(nutrition_data: dict, width: str, height: str) -> dict:
    ...
    return {
        ...
        "show_allergens": nutrition_data.get("show_allergens", False),
        "allergen_text": nutrition_data.get("allergen_text", ""),
        "show_ingredients": nutrition_data.get("show_ingredients", False),
        "ingredient_list_text": nutrition_data.get("ingredient_list_text", ""),
